...
\resizebox{.6\linewidth}{!}{\scshape Cours}

\vskip -1ex

\resizebox{.9\linewidth}{!}{\scshape Probabilités discrètes}


\vskip 2em
\tikz[scale=0.55,yscale=.2, draw=GreenPine]{\draw (0,0) rectangle (1,1);
...
\resizebox{.75\linewidth}{!}{\scshape Classes MP/MP*}
...
\resizebox{.35\linewidth}{!}{\scshape Sadik Boujaida}

\vskip .5in

\resizebox{.2\linewidth}{!}{1th Edition}
